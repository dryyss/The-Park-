...
export function AdminShell({
  ...
  return (
    <div className="flex min-h-screen bg-[#141818]">
      <aside className="sticky top-0 flex h-screen w-[240px] shrink-0 flex-col border-r border-charbon-600 bg-charbon">
        <div className="border-b border-charbon-600 px-5 py-5">
          ...
          <div className="mt-3 rounded-md border border-charbon-500 bg-charbon-800 px-2.5 py-2">
        ...
        <div className="space-y-1 border-t border-charbon-600 px-3 py-4">
          <Link
            href="/"
            className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-[12px] font-bold text-texte-doux transition hover:bg-charbon-700 hover:text-blanc-casse"
          >
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-14 shrink-0 items-center border-b border-charbon-600 bg-charbon/95 px-6 backdrop-blur-sm lg:hidden">
